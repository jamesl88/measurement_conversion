<?php
  ...
  function convert_from_kiliogram($value, $to_unit) {
  ...
  function convert_mass($value, $from_unit, $to_unit) {
    $kg_value = convert_to_kilogram($value, $from_unit);
    $new_value = convert_from_kiliogram($kg_value, $to_unit);
    return $new_value;
  }
